This explains briefly how to run the program and what the files contain.
...
To run the program you may need to install some libraries:
keras, scikit-learn, matplotlib, seaborn, pandas, numpy and nltk